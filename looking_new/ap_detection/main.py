...
parser.add_argument('-d', dest='d', type=str, help='Which dataset to use', default="JAAD")
...
GT_PATH = os.path.join(os.getcwd(), 'input_{}'.format(args.d), 'ground-truth')
DR_PATH = os.path.join(os.getcwd(), 'input_{}'.format(args.d), 'detection-results')
...
output_files_path = "output_{}".format(args.d)
