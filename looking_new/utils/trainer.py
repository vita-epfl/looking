    ...
    def get_data(self, data_type):
        ...
        if self.multi_dataset:
            ...
            if data_type == 'JAAD':
                ...
                path_data = self.data_args['path_data']
                dataset_train = LOOK_dataset_('train', self.model_type_, path_txt, path_data, self.pose, self.data_transform, self.device)
                dataset_val = LOOK_dataset_('val', self.model_type_, path_txt, path_data, self.pose, self.data_transform, self.device)
