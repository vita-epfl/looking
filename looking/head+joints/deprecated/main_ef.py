...
model = LookingNet_early_fusion("../head/models/resnet_head_best.p", "../joints/models/looking_model_jaad.p", device).to(device)
...
loss = nn.BCELoss()
optimizer = torch.optim.SGD(model.w1.parameters(), lr=0.001, momentum=0.9, weight_decay=0.0005)
