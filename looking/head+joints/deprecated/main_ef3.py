...
model = LookingNet_early_fusion_4("../head/models/resnet_head_best.p", "../joints/models/looking_model_jaad.p", device).to(device)
...
losses = []
ap_max = 0
writer = SummaryWriter(log_dir="./runs6")
for e in range(EPOCHS):
	...
	if ap > ap_max:
		ap_max = ap
		torch.save(model.state_dict(), "./models/model_early_stop_5.p")
	model.train()
	#break
