...
This may take some time depending on your machine configuration.
...
### 2.1. If you want to download our keypoints: 
...
### 2.2. If you want to run Pifpaf keypoints detector by yourself
...
### 2.3. If you want to run another keypoints detector by yourself
